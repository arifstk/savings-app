      ...
      <div className="w-[95%] md:w-[90%] mx-auto flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-5">
          ...
          {(role === "user" || role === "admin") && (
            <Link href="/subscriptions" className={linkStyles(pathname === "/subscriptions")}>
              Subscriptions
              <NavUnderline isActive={pathname === "/subscriptions"} />
            </Link>
          )}
        ...
        <div className="flex items-center gap-3">
          ...
          {session?.user?.role === "admin" && (
            <Link
              ...
              className="hidden md:flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-linear-to-r from-teal-500 to-cyan-500 border border-violet-500/30 text-violet-900 text-xs font-semibold hover:bg-violet-600/30 transition-all duration-200"
            >
