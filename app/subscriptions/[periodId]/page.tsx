      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="flex items-start justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg md:text-2xl font-bold text-gray-900">{period?.name ?? "Period"}</h1>
              {period && (
          ...
          <Link
            ...
            target="_blank"
            className="flex items-center gap-2 bg-linear-to-r from-teal-500 to-cyan-500 hover:bg-linear-to-r hover:from-teal-600 hover:to-cyan-600  text-white text-sm font-medium px-3 py-2 rounded-xl transition"
          >
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                <thead className="bg-linear-to-r from-teal-500 to-cyan-500 text-white">
                  <tr>
                    <th className="px-3 py-2.5 md:px-5 md:py-3.5 text-left text-xs font-semibold uppercase tracking-wide w-12">S.I.</th>
                    <th className="px-2 py-2.5 md:px-5 md:py-3.5 text-left text-xs font-semibold uppercase tracking-wide">Month</th>
                    <th className="px-2 py-2.5 md:px-5 md:py-3.5 text-left text-xs font-semibold uppercase tracking-wide">Payment Date</th>
                    <th className="px-2 py-2.5 md:px-5 md:py-3.5 text-left text-xs font-semibold uppercase tracking-wide">Amount</th>
                    <th className="px-2 py-2.5 md:px-5 md:py-3.5 text-left text-xs font-semibold uppercase tracking-wide">Status</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-100">
                  {rows.map((row, idx) => (
                    <tr key={row._id} className={idx % 2 === 0 ? "bg-white" : "bg-gray-50"}>
                      <td className="px-2 py-2.5 md:px-5 md:py-3.5 text-gray-400 text-xs">{row.serial}</td>
                      <td className="px-2 py-2.5 md:px-5 md:py-3.5 font-medium text-xs md:text-sm text-gray-800">{displayMonth(row.month)}</td>
                      <td className="px-2 py-2.5 md:px-5 md:py-3.5 text-sm text-gray-600 whitespace-nowrap">
                        {row.status === "paid" ? fmtDate(row.paidAt) : "—"}
                      </td>
                      <td className="px-2 py-2.5 md:px-5 md:py-3.5 font-semibold text-gray-800 whitespace-nowrap">
                        {fmtTaka(row.fee)}
                      </td>
                      <td className="px-2 py-2.5 md:px-5 md:py-3.5">
                ...
                <tfoot>
                  <tr className="bg-linear-to-r from-teal-500 to-cyan-500 text-white">
                    <td colSpan={3} className="px-2 py-2.5 md:px-5 md:py-3.5 text-sm font-bold text-right">Total Paid =</td>
                    <td className="px-2 py-2.5 md:px-5 md:py-3.5 text-sm font-bold text-white whitespace-nowrap">
                      {fmtTaka(totalPaid)}
                    </td>
                    <td />
                  </tr>
