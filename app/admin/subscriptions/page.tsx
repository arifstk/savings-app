...
/* ── MonthYearPicker ─────────────────────────────────────────────────
   Replaces <input type="month"> which doesn't render on all browsers.
   Shows two selects: Month | Year → outputs "YYYY-MM" string.
──────────────────────────────────────────────────────────────────── */
const FULL_MONTHS = [
  ...
  return (
    <div>
      ...
      <div className="flex gap-1.5">
        ...
        <select
          value={selMonth}
          onChange={e => { setSelMonth(e.target.value); update(selYear, e.target.value); }}
          className="flex-1 border border-gray-300 rounded-lg px-2 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white"
        >
        ...
        <select
          value={selYear}
          onChange={e => { setSelYear(e.target.value); update(e.target.value, selMonth); }}
          className="w-24 border border-gray-300 rounded-lg px-2 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white"
        >
